      ...
      <IonHeader>
        <IonToolbar>
          ...
          <IonButtons slot="end" className="toolbar-buttons">
            ...
            <IonInput placeholder="Search" type="text" className="search-input" />
